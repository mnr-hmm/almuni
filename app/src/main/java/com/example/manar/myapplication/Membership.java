...
public class Membership extends Activity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> collegeAdapter = new ArrayAdapter<String>(Membership.this,
    ...
    public void onClick(View view){
        ...
        almuniDBHelper.insertRequest("Membership",arabicName,englishname,Age,gnd,nationID,Major,college,date,eml,Phone,Address,studentID);
